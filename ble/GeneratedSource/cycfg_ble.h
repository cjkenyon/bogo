...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x71u)

/** The size of the cy_ble_attValuesLen array */
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x1Cu)

/** GATT Role */
#define CY_BLE_GATT_ROLE                            (0x01u)
#define CY_BLE_GATT_DB_CCCD_COUNT                   (0x00u)
#define CY_BLE_ATT_UUID_128_COUNT                   (0x0Cu)
...
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_COUNT                    (0x06u)
...
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_COUNT               (0x06u)

/** The size of the cy_ble_customSDesc array */
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_DESCRIPTORS_COUNT   (0x06u)
 ...
 */
#define CY_BLE_LEDS_SERVICE_INDEX   (0x00u) /* Index of LEDs service in the cy_ble_customSServ array */
#define CY_BLE_LEDS_USR_LED_CHAR_INDEX   (0x00u) /* Index of USR LED characteristic */
#define CY_BLE_LEDS_USR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_BUTTONS_SERVICE_INDEX   (0x01u) /* Index of BUTTONS service in the cy_ble_customSServ array */
#define CY_BLE_BUTTONS_USR_BTN_CHAR_INDEX   (0x00u) /* Index of USR BTN characteristic */
#define CY_BLE_BUTTONS_USR_BTN_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_MOTOR_SERVICE_INDEX   (0x02u) /* Index of MOTOR service in the cy_ble_customSServ array */
#define CY_BLE_MOTOR_MOTOR_CHAR_INDEX   (0x00u) /* Index of MOTOR characteristic */
#define CY_BLE_MOTOR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_TEMP_SERVICE_INDEX   (0x03u) /* Index of TEMP service in the cy_ble_customSServ array */
#define CY_BLE_TEMP_USR_TEMP_CHAR_INDEX   (0x00u) /* Index of USR TEMP characteristic */
#define CY_BLE_TEMP_USR_TEMP_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_PUMP_SERVICE_INDEX   (0x04u) /* Index of PUMP service in the cy_ble_customSServ array */
#define CY_BLE_PUMP_USR_PUMP_CHAR_INDEX   (0x00u) /* Index of USR PUMP characteristic */
#define CY_BLE_PUMP_USR_PUMP_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_BUZZER_SERVICE_INDEX   (0x05u) /* Index of BUZZER service in the cy_ble_customSServ array */
#define CY_BLE_BUZZER_USR_BUZZER_CHAR_INDEX   (0x00u) /* Index of USR BUZZER characteristic */
#define CY_BLE_BUZZER_USR_BUZZER_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_LEDS_SERVICE_HANDLE   (0x000Du) /* Handle of LEDs service */
#define CY_BLE_LEDS_USR_LED_DECL_HANDLE   (0x000Eu) /* Handle of USR LED characteristic declaration */
#define CY_BLE_LEDS_USR_LED_CHAR_HANDLE   (0x000Fu) /* Handle of USR LED characteristic */
#define CY_BLE_LEDS_USR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_BUTTONS_SERVICE_HANDLE   (0x0011u) /* Handle of BUTTONS service */
#define CY_BLE_BUTTONS_USR_BTN_DECL_HANDLE   (0x0012u) /* Handle of USR BTN characteristic declaration */
#define CY_BLE_BUTTONS_USR_BTN_CHAR_HANDLE   (0x0013u) /* Handle of USR BTN characteristic */
#define CY_BLE_BUTTONS_USR_BTN_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_MOTOR_SERVICE_HANDLE   (0x0015u) /* Handle of MOTOR service */
#define CY_BLE_MOTOR_MOTOR_DECL_HANDLE   (0x0016u) /* Handle of MOTOR characteristic declaration */
#define CY_BLE_MOTOR_MOTOR_CHAR_HANDLE   (0x0017u) /* Handle of MOTOR characteristic */
#define CY_BLE_MOTOR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0018u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_TEMP_SERVICE_HANDLE   (0x0019u) /* Handle of TEMP service */
#define CY_BLE_TEMP_USR_TEMP_DECL_HANDLE   (0x001Au) /* Handle of USR TEMP characteristic declaration */
#define CY_BLE_TEMP_USR_TEMP_CHAR_HANDLE   (0x001Bu) /* Handle of USR TEMP characteristic */
#define CY_BLE_TEMP_USR_TEMP_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Cu) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_PUMP_SERVICE_HANDLE   (0x001Du) /* Handle of PUMP service */
#define CY_BLE_PUMP_USR_PUMP_DECL_HANDLE   (0x001Eu) /* Handle of USR PUMP characteristic declaration */
#define CY_BLE_PUMP_USR_PUMP_CHAR_HANDLE   (0x001Fu) /* Handle of USR PUMP characteristic */
#define CY_BLE_PUMP_USR_PUMP_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0020u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_BUZZER_SERVICE_HANDLE   (0x0021u) /* Handle of BUZZER service */
#define CY_BLE_BUZZER_USR_BUZZER_DECL_HANDLE   (0x0022u) /* Handle of USR BUZZER characteristic declaration */
#define CY_BLE_BUZZER_USR_BUZZER_CHAR_HANDLE   (0x0023u) /* Handle of USR BUZZER characteristic */
#define CY_BLE_BUZZER_USR_BUZZER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0024u) /* Handle of Characteristic User Description descriptor */
